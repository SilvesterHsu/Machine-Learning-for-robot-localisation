...
parser.add_argument('--model_dir', type=str, default='/home/kevin/models/global_localization', help='')
parser.add_argument('--train_dataset', type=str, default = ['/home/kevin/data/michigan_nn_data/2012_01_08',
...
def run():
    ...
    with model.gp_model.enquire_session() as sess:
        ...
        if os.path.isfile(os.path.join(args.model_dir, 'config.pkl')):
            ...
            ckpt_file = os.path.join(args.model_dir, 'model-27.ckpt-10000' )
            ...
            ckpt_file = os.path.join(os.path.join(args.model_dir, "dual_resnet"), 'model-74.ckpt-300000')
            print('loading model: ', ckpt_file)
